...
import { useUpdateClientMutation } from "@/hooks/apis/ClientApi";
import { toast } from "react-toastify";
import { useNavigate } from "react-router-dom";

const EditClient = ({ nom, prenom, NumTelephone, email, password, id }) => {
  ...
  const handleSubmit = (event) => {
    ...
    updateClient({ id, body: updatedUserData })
      .unwrap()
      .then(() => {
        setIsSuccess(true);
      })
